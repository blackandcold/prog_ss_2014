...
happyReduction_15 (HappyTerminal (TKString _ happy_var_1))
	 =  HappyAbsSyn13
		 (Result happy_var_1
	)
...
happyReduction_24 (HappyTerminal (TKName _ happy_var_1))
	 =  HappyAbsSyn18
		 (Boolean happy_var_1
	)
...
happyReduction_25 (HappyTerminal (TKString _ happy_var_3))
	_
...
happyReduction_28 ((HappyTerminal (TKString _ happy_var_6)) `HappyStk`
...
happyReduction_29 ((HappyTerminal (TKString _ happy_var_5)) `HappyStk`
	_ `HappyStk`
	_ `HappyStk`
	(HappyTerminal (TKName _ happy_var_2)) `HappyStk`
	(HappyTerminal (TKName _ happy_var_1)) `HappyStk`
...
happyReduction_31 ((HappyTerminal (TKString _ happy_var_4)) `HappyStk`
	_ `HappyStk`
	_ `HappyStk`
	(HappyTerminal (TKName _ happy_var_1)) `HappyStk`
	happyRest)
...
happyReduction_32 (_ `HappyStk`
	(HappyTerminal (TKName _ happy_var_3)) `HappyStk`
	_ `HappyStk`
	(HappyTerminal (TKName _ happy_var_1)) `HappyStk`
	happyRest)
	 = HappyAbsSyn19
		 (Execution happy_var_1 (StdOutNil) happy_var_3 (StdInNil)
	) `HappyStk` happyRest
...
happyReduction_34 (HappyAbsSyn20  happy_var_2)
	(HappyTerminal (TKString _ happy_var_1))
	 =  HappyAbsSyn20
		 ([happy_var_1] ++ happy_var_2
	)
...
happyNewToken action sts stk (tk:tks) =
	...
	case tk of {
	TKFinally _ -> cont 21;
	TKName _ happy_dollar_dollar -> cont 22;
	TKString _ happy_dollar_dollar -> cont 23;
	TKExec _ -> cont 24;
	TKEquals _ -> cont 25;
	TKNotEquals _ -> cont 26;
	TKColon _ -> cont 27;
	TKSemicolon _ -> cont 28;
	TKAssignment _ -> cont 29;
	TKOpenBracket _ -> cont 30;
	TKCloseBracket _ -> cont 31;
	TKMinus _ -> cont 32;
	_ -> happyError' (tk:tks)
	}
